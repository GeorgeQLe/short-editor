...
| Audio editing | Pending | Complete audio state round-trips with Short revisions, but its dedicated mutation, deterministic validation, and render integration remain EDT-05 and later render milestones. |
