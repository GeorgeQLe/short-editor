...
export const starterTemplates: Template[] = [
  {
    ...
    composition: {
      ...
      layers: [
        { id: "subject", type: "image", source: "asset", assetId: null, region: { x: 0, y: 0, width: 1, height: 0.5 }, fit: "fill" },
        { id: "speaker", type: "video", source: "episode", assetId: null, region: { x: 0, y: 0.5, width: 1, height: 0.5 }, fit: "fill", cropTarget: "person", automaticCropTrack: { frames: [], provenance: null, fallback: { mode: "fill", reason: "missing_samples" } }, manualCropTrack: [] },
        { id: "captions", type: "captions", source: "none", assetId: null, region: { x: 0.08, y: 0.72, width: 0.84, height: 0.17 }, fit: "fit" }
      ]
    }
  },
  {
    ...
    composition: {
      ...
      layers: [
        { id: "speaker", type: "video", source: "episode", assetId: null, region: { x: 0, y: 0, width: 1, height: 1 }, fit: "fill", cropTarget: "person", automaticCropTrack: { frames: [], provenance: null, fallback: { mode: "fill", reason: "missing_samples" } }, manualCropTrack: [] },
        { id: "captions", type: "captions", source: "none", assetId: null, region: { x: 0.08, y: 0.7, width: 0.84, height: 0.18 }, fit: "fit" }
      ]
    }
  },
  {
    ...
    composition: {
      width: 1080, height: 1920, background: "#090b10", safeArea,
      layers: [
        { id: "screen", type: "video", source: "episode", assetId: null, region: { x: 0, y: 0, width: 1, height: 0.58 }, fit: "fill", cropTarget: "screen", automaticCropTrack: { frames: [], provenance: null, fallback: { mode: "fill", reason: "missing_samples" } }, manualCropTrack: [] },
        { id: "speaker", type: "video", source: "episode", assetId: null, region: { x: 0, y: 0.58, width: 1, height: 0.42 }, fit: "fill", cropTarget: "person", automaticCropTrack: { frames: [], provenance: null, fallback: { mode: "fill", reason: "missing_samples" } }, manualCropTrack: [] },
